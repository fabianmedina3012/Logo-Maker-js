...
const fs = require("fs");
// Shape classes (you can move these to a separate file and import if desired)
class Triangle {
  constructor() {}
}
class Square {
...
function writeToFile(fileName, answers) {
  ...
  // Conditional check takes user's input from choices array and then adds polygon properties and shape color to SVG string
  ...
  inquirer
    .prompt([
      ...
      // Shape color prompt
      {
        type: "input",
        message:
          "Choose shape color (Enter color keyword OR a hexadecimal number)",
...
// Calling promptUser function so inquirer prompts fire off when application is run
promptUser();